...
void BiomeUtils::init()
{
    ...
    host_materialInfos[(int)Material::GRAVEL] = { Block::GRAVEL, 1.1f, 33.f, 1.9f, vec2(170, 200) };
    host_materialInfos[(int)Material::DIRT] = { Block::DIRT, 4.2f, 22.f, 1.5f, vec2(155, 195) };
